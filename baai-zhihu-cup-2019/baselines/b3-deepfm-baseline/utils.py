...
class BaseModel(nn.Module):
    ...
    def fit(self, x=None,
        ...
        if save_results:
            ...
            file = open("E:\\competition\\看山杯\\result000.txt", 'a+', encoding='utf-8')
            file.write("\n")
            file.write("################################################################\n")
...
class xDeepFM(BaseModel):
    ...
    def __init__(self, linear_feature_columns, dnn_feature_columns, embedding_size=64, dnn_hidden_units=(256, 128),
                 ...
                 dnn_activation=F.relu, dnn_use_bn=False, task='binary', device='cuda:0'):
